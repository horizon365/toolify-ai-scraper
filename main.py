...
async def extract_tool_details(page, url, browser):
    ...
    try:
        ...
        # Get social links
        social_links = []
        social_els = await page.query_selector_all('a[href*="twitter.com"], a[href*="linkedin.com"], a[href*="facebook.com"], a[href*="instagram.com"]')
            ...
            if website_link:
                ...
                if tool_website:
                    ...
                    try:
                        ...
                        # Select best logo
                        if logo_candidates:
                            logo_candidates.sort(key=lambda x: (x['score'], -abs(x['dimensions'][0] - x['dimensions'][1])), reverse=True)
